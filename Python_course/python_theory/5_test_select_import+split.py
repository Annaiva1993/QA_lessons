...
# Существуют ситуации, когда базового выполнения недостаточно, порой надо выполнить доп действия на страница сайта , через скрипты на JavaScript
# Чтобы эти скрипты выполнялись используется метод 
# Execute_script
